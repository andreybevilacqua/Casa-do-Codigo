...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%>
			...
			<div id="header-content">
				<nav id="main-nav">
					<ul class="clearfix">
						...
						<li><a href="?locate=pt" rel="nofollow"> <fmt:message key="menu.pt"/>   </a></li>
						<li><a href="?locate=en_US" rel="nofollow"> <fmt:message key="menu.en"/>   </a></li>
					</ul>
				</nav>
			</div>
		</div>
	...
	<nav class="categories-nav">
		<ul class="container">
			<li class="category"><a href="${contextPath}produtos"> 
